  ...
  const formSubmit = async (event) => {
    ...
    if (name && email && message) {
      const res = await fetch(
        "https://database-c6c1a-default-rtdb.asia-southeast1.firebasedatabase.app/fakeecommerceapi.json",
        {
          method: "POST",
          headers: {
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
                ...
                <form method="POST">
                  <div className="relative">
                    ...
                    <input
                      ...
                      type="text"
                      id="name"
                      className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-700 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                  </div>
                </form>
              </div>
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a target="_blank" href="" className="text-blue-500">
